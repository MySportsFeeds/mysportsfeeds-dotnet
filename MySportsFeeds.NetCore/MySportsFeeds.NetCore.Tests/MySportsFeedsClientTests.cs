...
namespace MySportsFeeds.NetCore.IntegrationTests
{
    public class MySportsFeedsClientTests : TestBase
    {
        ...
        public async Task Can_Get_Playoff_Team_Standings()
        {
            ...
            var response = await mySportsFeedsClient.PlayoffTeamStandings.Get(League.MLB, 2018, SeasonType.Regular, requestOptions);
        ...
        public async Task Can_Get_Game_Box_Score()
        {
            ...
            var response = await mySportsFeedsClient.GameBoxScore.Get(League.MLB, 2018, SeasonType.Regular, requestOptions);
        ...
        public async Task Can_Get_Game_Starting_Lineup()
        {
            ...
            var response = await mySportsFeedsClient.GameStartingLineup.Get(League.MLB, 2018, SeasonType.Regular, requestOptions);
