...
namespace MySportsFeeds.NetCore.Api
{
    public class TeamGameLogs
    {
        ...
        /// The URL
        /// </summary>
        private const string Url = "/pull/{0}/{1}/team_gamelogs.json";
        ...
        /// <returns></returns>
        public async Task<TeamGameLogsResponse> Get(League league, int year, SeasonType seasonType, RequestOptions requestOptions = null)
        {
