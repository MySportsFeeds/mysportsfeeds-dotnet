...
namespace MySportsFeeds.NetCore.Api
{
    public class GameStartingLineup
    {
        ...
        /// The URL
        /// </summary>
        private const string Url = "/pull/{0}/{1}/game_startinglineup.json";
        ...
        /// <returns></returns>
        public async Task<GameStartingLineupResponse> Get(League league, int year, SeasonType seasonType, RequestOptions requestOptions = null)
        {
