...
namespace MySportsFeeds.NetCore.Mlb
{
    public class ConferenceTeamStandings
    {
        ...
        /// The URL
        /// </summary>
        private const string Url = "/pull/mlb/{0}/conference_team_standings.json";
        ...
        /// <returns></returns>
        public async Task<ConferenceTeamStandingsResponse> Get(int year, SeasonType seasonType, RequestOptions requestOptions = null)
        {
