...
namespace MySportsFeeds.NetCore.Mlb
{
    public class ActivePlayers
    {
        ...
        /// The URL
        /// </summary>
        private const string Url = "/pull/mlb/{0}/active_players.json";
        ...
        /// <returns></returns>
        public async Task<ActivePlayersResponse> Get(int year, SeasonType seasonType, RequestOptions requestOptions = null)
        {
